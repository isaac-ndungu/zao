...
export default function AccountantDisbursements() {
  ...
  return (
    <div>
      ...
      {loading ? <TableSkeleton rows={10} cols={6} /> : error ? <p className="text-error">Failed to load disbursements.</p> : (
        <DataTable
          columns={columns}
          data={disbursements}
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center" onClick={() => setSearchParams({ ...Object.fromEntries(searchParams.entries()), selected: undefined })}>
          <div className="bg-surface rounded-xl p-6 max-w-lg w-[90vw] max-h-[90vh] overflow-y-auto relative" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-start mb-6">
              ...
              <button onClick={() => setSearchParams({ ...Object.fromEntries(searchParams.entries()), selected: undefined })} className="text-on-surface-variant hover:text-on-surface"><span className="material-symbols-outlined">close</span></button>
            </div>
