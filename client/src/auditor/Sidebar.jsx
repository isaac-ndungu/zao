...
const bottomItems = [
  { to: '/auditor/profile', icon: 'person', label: 'Profile' },
  { to: '/auditor/settings', icon: 'settings', label: 'Settings' },
]

export default function AuditorSidebar({ mobileOpen, onClose, minimized }) {
  ...
  const sidebarContent = (
    <aside aria-label="Auditor sidebar" className={`${minimized ? 'w-16 px-2' : 'w-64 px-4'} h-full bg-primary flex flex-col py-6 overflow-y-auto transition-all duration-300`}>
