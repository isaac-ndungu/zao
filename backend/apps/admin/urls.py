...
from apps.admin.views import (
    ...
    AdminFarmerActivateView,
    AdminFarmerBinView,
    AdminFarmerBulkActionView,
    AdminFarmerDeactivateView,
    AdminFarmerDeleteView,
    AdminFarmerPaymentHoldView,
    AdminFarmerPaymentUnholdView,
...
urlpatterns = [
    ...
    path('farmers/<uuid:pk>/activate/', AdminFarmerActivateView.as_view()),
    path('farmers/<uuid:pk>/deactivate/', AdminFarmerDeactivateView.as_view()),
    path('farmers/<uuid:pk>/delete/', AdminFarmerDeleteView.as_view()),
    ...
    path('farmer-payments/<uuid:pk>/unhold/', AdminFarmerPaymentUnholdView.as_view()),
