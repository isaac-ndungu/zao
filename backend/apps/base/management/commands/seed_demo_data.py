    ...
    def _create_users(self, cooperatives):
        ...
        for coop in cooperatives:
            ...
            all_roles.extend([
                ...
                # Auditor roles — added for role dashboard development/testing.
                # Test password: Password123!
                (UserRole.AUDITOR, f"{prefix}_auditor", "Auditor", coop),
                (UserRole.EXTERNAL_AUDITOR, f"{prefix}_extauditor", "ExtAuditor", coop),
            ])
        ...
        self.stdout.write(
            "  Auditor accounts use password: Password123!\n"
            "  e.g. kdf_auditor.auditor@zao.app / kdf_extauditor.extauditor@zao.app"
        )
        return users
